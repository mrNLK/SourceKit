          ...
          <AnimateOnScroll direction="left">
            <div className="flex flex-col gap-6">
              ...
              <h1 className="text-4xl md:text-5xl lg:text-[3.25rem] font-semibold leading-tight tracking-tight text-white">
                Structured developer evidence for agentic recruiting.
              </h1>

              <p className="text-sk-muted text-base max-w-md leading-relaxed">
                Give AI recruiters, sourcing agents, and gen-AI hiring tools
                machine-readable proof of engineering ability — ranked from
                real GitHub work, enriched with company and ecosystem context.
              </p>

              <div className="flex flex-wrap gap-2 mt-1">
                {["Agent-ready", "Structured evidence", "GitHub-native", "Recruiter workflows", "API-friendly"].map((tag) => (
