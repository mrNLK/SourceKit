...
<head>
  ...
  <style>
    @import url('https://fonts.googleapis.com/css2?family=Fraunces:opsz,wght@9..144,500;9..144,600;9..144,700&family=Spline+Sans:wght@400;500;600;700&family=Spline+Sans+Mono:wght@400;500;600&display=swap');
    @page { margin: 0.55in; }
    :root {
    ...
    * { box-sizing: border-box; }
    body {
      ...
      color: var(--ink);
      background:
        repeating-linear-gradient(180deg, rgba(119,141,169,0.07) 0, rgba(119,141,169,0.07) 1px, transparent 1px, transparent 64px),
        var(--paper);
    ...
    .cover {
      ...
      background: linear-gradient(150deg, #0d1b2a 0%, #1b263b 48%, #2c405c 100%);
      color: var(--alabaster);
      box-shadow: 0 30px 80px rgba(13,27,42,0.35);
    }
    .cover::before {
      content: "";
      position: absolute;
      ...
      width: 720px;
      height: 720px;
      background: repeating-radial-gradient(circle at center, transparent 0, transparent 54px, rgba(224,225,221,0.07) 54px, rgba(224,225,221,0.07) 56px);
      border-radius: 50%;
      pointer-events: none;
    }
    .cover::after {
      ...
      box-shadow: 0 0 0 6px rgba(119,141,169,0.25), 0 0 24px 4px rgba(119,141,169,0.55);
      pointer-events: none;
    }
    .kicker {
      margin: 0 0 14px;
    ...
    h1, h2, h3 { line-height: 1.08; margin: 0; font-family: var(--font-display); }
    h1 { font-size: 52px; font-weight: 700; letter-spacing: -0.015em; }
    h2 { font-size: 27px; font-weight: 600; margin-top: 34px; letter-spacing: -0.01em; }
    ...
    .card h2::before {
      ...
      border-radius: 50%;
      background: var(--dusk);
      box-shadow: 0 0 0 3px var(--surface), 0 0 0 4px var(--denim);
      vertical-align: 3px;
    }
    p { margin: 10px 0 0; }
    .cover h1 { color: #f4f5f1; }
    .cover p { color: #b8c4d4; max-width: 800px; font-size: 16.5px; position: relative; }
    .meta {
      display: flex;
      flex-wrap: wrap;
      gap: 10px;
    ...
    .card {
      ...
      box-shadow: 0 14px 38px rgba(13,27,42,0.1);
    }
    ...
    .onboarding-panel {
      ...
      margin-top: 18px;
      padding: 16px;
      background: linear-gradient(180deg, rgba(119,141,169,0.1), rgba(224,225,221,0.4));
    }
    .onboarding-rail {
      display: grid;
    ...
    .step-number {
      ...
      font-size: 15px;
      font-weight: 600;
      box-shadow: 0 0 0 2px var(--surface), 0 0 0 3px var(--denim);
    }
    .summary-copy strong {
      display: block;
      color: var(--ink);
    ...
    .onboarding-body {
      ...
      padding: 16px;
      background: linear-gradient(180deg, rgba(119,141,169,0.08), rgba(242,243,239,0.9));
    }
    .answer-grid {
      display: grid;
    ...
    li { margin: 7px 0; }
    strong { color: var(--prussian); }
    a { color: var(--dusk); font-weight: 600; text-decoration-color: var(--denim); text-underline-offset: 2px; }
    code {
      border: 1px solid var(--line);
      border-radius: 2px;
      padding: 2px 6px;
    ...
    .warning strong { color: var(--denim); }
    .compact li { margin: 4px 0; }
    .small { color: var(--dusk); font-size: 13px; }
    @media screen {
      .cover, .card {
        animation: surface 640ms cubic-bezier(0.22, 1, 0.36, 1) both;
      }
    ...
    @media print {
      ...
      main { padding: 0; }
      .card, figure, .cover { box-shadow: none; animation: none; }
    }
